...
avg_checkout = FOREACH avg_group GENERATE FLATTEN(group) as (checkouts), SUM($1.count_checkouts)/150 as avg;
STORE avg_checkout INTO '/uhadoop2019/pablojose/stats/sum_check_div_total_months1';
